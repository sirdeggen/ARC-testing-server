...
const UnlockingScript_js_1 = require("../script/UnlockingScript.js");
const LockingScript_js_1 = require("../script/LockingScript.js");
const utils_js_1 = require("../primitives/utils.js");
const Hash_js_1 = require("../primitives/Hash.js");
const SatoshisPerKilobyte_js_1 = require("./fee-models/SatoshisPerKilobyte.js");
const MerklePath_js_1 = require("./MerklePath.js");
const Spend_js_1 = require("../script/Spend.js");
/**
...
class Transaction {
    ...
    async fee(model, changeDistribution = 'equal') {
        if (typeof model === 'undefined') {
            model = new SatoshisPerKilobyte_js_1.default(10);
        }
     ...
     */
    hash(enc) {
        return (0, Hash_js_1.hash256)(this.toBinary(), enc);
    }
    /**
     ...
     */
    id(enc) {
        const id = (0, Hash_js_1.hash256)(this.toBinary());
        id.reverse();
        if (enc === 'hex') {
